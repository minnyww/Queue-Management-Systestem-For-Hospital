        ...
        <Segment attached="bottom" color="teal">
          ...
          <Form>
            ...
            <Form.Field
              ...
              onChange={(e, { value }) =>
                props.setField("departmentName", value)
              }
            />
            <Form.Field
              required
              ...
              onChange={(e, { value }) =>
                props.setField("typeOfDepartment", value)
              }
            />
            {/* </Form.Group> */}
          </Form>
...
const showContent = props => {
  ...
  } else if (props.activeItem === "queue") {
    tmp = (
      <div>
        <Segment color="blue" style={{ maxHeight: "200%" }}>
          <Header>
          ...
          <Form>
            ...
            <Form.Group widths="equal">
              <Form.Field
                ...
                onChange={(e, { value }) =>
                  props.setField("departmentValueId", value)
                }
              />
            </Form.Group>
          </Form>
          ...
          <Form>
            <Form.Group widths="equal">
              <Form.Field
                ...
                onChange={(e, { value }) =>
                  props.setField("firstnameDoctor", value)
                }
              />
            </Form.Group>
            <Form.Group widths="equal">
              <Form.Field
                ...
                onChange={(e, { value }) =>
                  props.setField("lastnameDoctor", value)
                }
              />
            </Form.Group>
            <Form.Group widths="equal">
            ...
            <Form.Group widths="equal">
              <Form.Field
                ...
                onChange={(e, { value }) =>
                  props.setField("avgTimeDoctor", value)
                }
              />
            </Form.Group>
            <Form.Group widths="equal">
          ...
          <Form>
            <Form.Group widths="equal">
              <Form.Field
                ...
                placeholder="Firstname"
                onChange={(e, { value }) =>
                  props.setField("firstnamePatient", value)
                }
              />
            </Form.Group>
            <Form.Group widths="equal">
              <Form.Field
                ...
                placeholder="Lastname"
                onChange={(e, { value }) =>
                  props.setField("lastnamePatient", value)
                }
              />
            </Form.Group>
            <Form.Group widths="equal">
            ...
            <Form.Group widths="equal">
              <Form.Input
                ...
                onChange={(e, { value }) =>
                  props.setField("phonenumber", value)
                }
              />
              <Form.Input
                required
            ...
            <Segment color="teal">
              ...
              <Menu fluid vertical tabular color="teal">
                ...
                <Menu.Item
                  name="Queue"
                  onClick={() => {
                    props.setField("activeItem", "queue");
                  }}
                  active={props.activeItem === "queue" ? true : false}
                >
                  Queue
                </Menu.Item>
              </Menu>
